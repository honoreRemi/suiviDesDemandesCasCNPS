...
<body class="bg-body-tertiary">
    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="row g-5 justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <form class="needs-validation" method="post" novalidate action="../../Controler/admin/creerUtilisateur.admin.cntrl.php">
                        <div class="row g-3">
                            <div class="col-sm-6">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group has-validation">
                                    <input type="date" class="form-control" id="dateCreation" name="dateCreation" placeholder="votre numero de telephone " required>
                                    <div class="invalid-feedback">
                        ...
                        <button class="w-100 mt-3 btn btn-primary btn-lg" name="Creer" type="submit">CréerUser</button>
                </div>
        ...
        <p class="mb-1 text-center text-small mt-3 mb-3">&copy; 2022–2023 MASSACK HONORE REMI</p>
