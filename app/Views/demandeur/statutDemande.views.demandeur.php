        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr>
              ...
              <th scope="col">Certificat_de_scolarité</th>
              <th scope="col">C V</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="modifierDemande.view.demandeur.php?id=<?= $donnees['id'] ?>" class="d-inline-block">
                  <img src="../../../public/images/modifier.jpg" class="img-fluid" style="max-width: 40px;">
                </a>
              </td>
            </tr>
        <?php
